...
import { CheckoutLogin } from '../checkout/checkout-login/checkout-login';
...
export class CartPage {
    ...
    constructor(public modalCtrl: ModalController, public viewCtrl: ViewController, public nav: NavController, public service: CartService, public values: Values, public params: NavParams, public functions: Functions, private toastCtrl: ToastController) {
        this.Apply = "Apply";
    ...
    checkout() {
        ...
        if(!this.values.isLoggedIn){
           let modal = this.modalCtrl.create(CheckoutLogin);
