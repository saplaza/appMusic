...
export class Categories {
    ...
    constructor(public nav: NavController, public service: Service, public values: Values, public functions: Functions, public modalCtrl: ModalController, private backbuttonService: BackbuttonService) {
        this.items = [];
        this.subCategories = [];
    ...
    ionViewWillEnter() {
     this.backbuttonService.pushPage(EN_TAB_PAGES.EN_TP_CATEGORY, this.nav);
    }
    getCategory(id, name) {
