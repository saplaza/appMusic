...
export class BillingAddressForm {
    ...
    tabBarElement: any;
    loading: any;
    constructor(public modalCtrl: ModalController, public iab: InAppBrowser, public nav: NavController, public platform: Platform, private oneSignal: OneSignal, public service: CheckoutService, params: NavParams, public functions: Functions, public values: Values) {
    ...
    validateAddress() {
        ...
        else if (this.form.billing_first_name == undefined || this.form.billing_first_name == "") {
            this.functions.showAlert("ERROR", "Please enter billing First name");
            this.editBillingForm();
            return false            
        }
        else if (this.form.billing_phone == undefined || this.form.billing_phone == "") {
            this.functions.showAlert("ERROR", "Please enter billing Phone number");
            this.editBillingForm();
            return false
        }
        else if (this.form.billing_address_1 == undefined || this.form.billing_address_1 == "") {
            this.functions.showAlert("ERROR", "Please enter billing Address");
            this.editBillingForm();
            return false
        }
        else if (this.form.billing_email == undefined || this.form.billing_email == "") {
            this.functions.showAlert("ERROR", "Please enter billing Email");
            this.editBillingForm();
            return false
        }
        else if (this.form.billing_city == undefined || this.form.billing_city == "") {
            this.functions.showAlert("ERROR", "Please enter billing City");
            this.editBillingForm();
            return false
        }
        else if (this.form.billing_postcode == undefined || this.form.billing_postcode == "") {
            this.functions.showAlert("ERROR", "Please enter billing Postcode");
            this.editBillingForm();
            return false
        }
        else if (this.form.billing_country == undefined || this.form.billing_country == "") {
            this.functions.showAlert("ERROR", "Please choose billing Country");
            this.editBillingForm();
            return false
        }
        else if (this.form.billing_state == undefined || this.form.billing_state == "") {
            this.functions.showAlert("ERROR", "Please choose billing State");
            this.editBillingForm();
            return false
        }
        else if (this.form.shipping_first_name == undefined || this.form.shipping_first_name == "") {
            this.functions.showAlert("ERROR", "Please enter Shipping First name");
            return false
        }
        else if (this.form.shipping_address_1 == undefined || this.form.shipping_address_1 == "") {
            this.functions.showAlert("ERROR", "Please enter Shipping Address");
            return false
        }
        else if (this.form.shipping_city == undefined || this.form.shipping_city == "") {
            this.functions.showAlert("ERROR", "Please enter Shipping City");
            return false
        }
        else if (this.form.shipping_country == undefined || this.form.shipping_country == "") {
            this.functions.showAlert("ERROR", "Please choose Shipping Country");
            return false
        }
        else if (this.form.shipping_state == undefined || this.form.shipping_state == "") {
            this.functions.showAlert("ERROR", "Please choose Shipping State");
            return false
        }
        else if (this.form.shipping_postcode == undefined || this.form.shipping_postcode == "") {
            this.functions.showAlert("ERROR", "Please enter Shipping Postcode");
            return false
        } else {
            return true
