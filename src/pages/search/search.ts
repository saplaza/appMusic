...
export class SearchPage {
    ...
    constructor(public mainservice: Service, public modalCtrl: ModalController, public nav: NavController, public service: SearchService, public values: Values, params: NavParams, public functions: Functions, private backbuttonService: BackbuttonService) {
        this.filter = {};
    ...
    ionViewWillEnter() {
     this.backbuttonService.pushPage(EN_TAB_PAGES.EN_TP_SEARCH, this.nav);
    }
    getCart() {
